"""``skills-hub doctor`` — self-check окружения CLI (E3, образец reverse-factory).
...
5. **PATH-стор** — bin-каталог CLI-шимов (``~/.skills-hub/bin``) в PATH? warn
...
from skills_hub_cli.output import emit_data, is_json
